package com.quchwe.cms.util.compressor;
...
public class Compressor {
    ...
    //max width and height values of the compressed cirecleImage is taken as 612x816
    ...
    private Compressor(Context context) {
        ...
        destinationDirectoryPath =Environment.getExternalStoragePublicDirectory(
                Environment.DIRECTORY_PICTURES) + File.pathSeparator + FileUtil.FILES_PATH;
    }
