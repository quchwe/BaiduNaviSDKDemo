...
public interface IPhotoView {
    ...
    /**
     * Controls how the cirecleImage should be resized or moved to match the size of the ImageView. Any
    ...
    /**
     * Extracts currently visible area to Bitmap object, if there is no cirecleImage loaded yet or the
