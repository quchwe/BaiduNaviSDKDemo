 ...
 * shows feedback as the cirecleImage processing is happening, and then overlays the
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
    ...
    public static final String QR_STRING = "result";
...
//                    BaseActivity.REQUEST_CODE_CAMERA);
//        }
...
//        requestCameraPermission();
        ...
        title.setText(getString(R.string.qrCode));
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        bundle.putString(QR_STRING, rawResult.getText());
